...
{
	private static string _reset_to_edl = "<?xml version=\"1.0\" ?><data><power verbose=\"{0}\"  value=\"reset_to_edl\" DelayInSeconds=\"1\"/></data>";

	private static string _partial_reset = "<?xml version=\"1.0\" ?><data><power verbose=\"{0}\"  value=\"partial_reset\"/></data>";

	private static string _reset = "<?xml version=\"1.0\" ?><data><power verbose=\"{0}\"  value=\"reset\"/></data>";
	...
	private static string _erase = "<?xml version=\"1.0\" ?><data><erase SECTOR_SIZE_IN_BYTES=\"{0}\" physical_partition_number=\"{1}\"/></data>";

	private static string _peek = "<?xml version=\"1.0\" ?><data><peek size_in_bytes=\"4\" address64=\"0x00780198\"/></data>";

	private static string _peekCupid = "<?xml version=\"1.0\" ?><data><peek size_in_bytes=\"10\" address64=\"0x00786134\"/></data>";

	private static string _xblgpt = "<?xml version=\"1.0\" ?><data><xblgpt lun=\"{0}\"/></data>";

	private static string _getStorageInfo = "<?xml version=\"1.0\" ?><data><getStorageInfo physical_partition_number=\"0\"/></data>";

	public const int PROGRAMMER_LITE = 1;

	public const int PROGRAMMER_DDR4 = 2;

	public const int PROGRAMMER_DDR5 = 3;
	...
	public static string ERASE => _erase;
	...
	public static string FIREHOSE_READ => "<?xml version=\"1.0\" ?><data><read SECTOR_SIZE_IN_BYTES=\"{0}\" num_partition_sectors=\"{1}\" start_sector=\"{2}\" physical_partition_number=\"{3}\" size_in_KB=\"{4}\" {5}/></data>";
